...
- **四個頁面的頁尾有署名、版本號與授權**（製作：潘V 醫師｜家醫科；CC BY-NC-ND 4.0；GitHub Issues 當回報管道）。改動內容時**版本號與日期要一起更新**，那是使用者判斷手上是不是最新版的唯一依據；署名與授權不要拿掉。
